...
SALICON_PATH = "/Users/coconut/Documents/Dataset/Saliency/SALICON/val/"
MIT1003 = "/Users/coconut/Documents/Dataset/Saliency/MIT1003/"
P3_PATH = "/Users/coconut/Documents/Dataset/Saliency/P3_data/"
O3_PATH = "/Users/coconut/Documents/Dataset/Saliency/O3_data/"
...
def run_dataset_MIT1003(args, saliency_model, rarity_model, file_opener):
    results = []
    files = os.listdir(MIT1003 + "images")
    start_time_global = time.time()
    
    for index, filename in enumerate(files):
        go_path = os.path.join(MIT1003 + "images", filename)
        ...
        fix = cv2.imread(os.path.join(MIT1003 + "fixation" , filename.replace(".jpeg" , "_fixMap.jpg")),0)
        sal = cv2.imread(os.path.join(MIT1003 + "saliency" , filename.replace(".jpeg" , "SM.jpg")),0)
        ...
        for key, v in maps.items():
            ...
            data['metrics'][key] = {    
                'NSS': float(round(metrics.NSS_score(map_, fix), 4)),
                'CC': float(round(metrics.CC_score(map_, sal), 4)),
                'KLD': float(round(metrics.KLdiv(map_, fix), 4)),
                'SIM': float(round(metrics.SIM(map_, sal), 4)),
...
if __name__ == "__main__":
    ...
    # Create folder name from parser arguments
